...
@Service(EvictionStrategyConstant.LEAST_FREQUENTLY_USED_STRATEGY)
@RequiredArgsConstructor
public class LeastFrequentlyUsedEvictionStrategy implements ChangeAbleEvictionStrategy {
  ...
  public Mono<Boolean> evict() {
    return Mono.fromSupplier(() -> cacheRepository)
      ...
      .sort(Comparator.comparingLong(CacheData::getAccessedCount))
      .elementAt(0)
